...
function Transactions() {
    ...
    return (
        <div className="transactions-container">
            ...
            <i className="fa-solid fa-indian-rupee-sign"></i> <input type='number' className="transactions-input" placeholder="Enter Amount for Transaction" value={amount} onChange={(e) => setAmount(e.target.value)}/> <br />
